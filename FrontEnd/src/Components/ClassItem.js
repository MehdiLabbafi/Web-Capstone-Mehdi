                        ...
                        return (
                            ...
                            <div key={v4()} className=' border-set justify-between flex py-4 px-2 border-b-2 border-gray-600 border-opacity-25'>
                                <div className='flex'>
                                    ...
                                    <p className='hidden sm:block text-center font-Shabnam_Thin dark:text-gray-400 text-bg_dark-200 border-2 border-gray-800 border-opacity-50 shadow-sm shadow-gray-600 dark:shadow-slate-800 px-4 py-1 rounded-xl' style={{ minWidth: "150px" }}>{data[2] + "  Up to  " + data[3]}</p>
                                </div>
                                <a target={"_blank"} href={IsYetStart && !IsYetEnd && isToday ? data[1] : ""} className={"flex  " + (IsYetStart && !IsYetEnd && isToday ? " pointer-events-auto text-white hover:text-green-400" : "pointer-events-none text-gray-500")} >Join the meeting
