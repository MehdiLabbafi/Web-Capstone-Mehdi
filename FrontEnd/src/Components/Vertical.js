            ...
            <div className={'w-72 h-screen fixed z-40 bg-bg_light-100 sidebar dark:bg-bg_dark-50 right-0 parent-scroll shadow-lg '} dir='rtl' id='sidebar'>
                ...
                <div className='mx-4 pb-3 px-4 mt-9'>
                    <nav className='font-Shabnam_Medium'>
                        {/* -----------First Part----------- */}
                        <ul>
                            <p className='dark:text-gray-500 text-bg_dark-100 border-b-2 dark:border-gray-700 pb-2 uppercase mb-8 font-Shabnam_Light'>Menu</p>
                        ...
                        {/* -----------Second Part----------- */}
                        <ul className='mt-16'>
                            <p className='dark:text-gray-500 text-bg_dark-100 border-b-2 dark:border-gray-700 pb-2 uppercase mb-8 font-Shabnam_Light'>Others</p>
